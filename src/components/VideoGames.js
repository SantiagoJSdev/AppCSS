...
import { startDataGamesPrueba, startDataGenresPrueba, startDataPlatformPrueba } from '../actions/dataPruebaAction';
...
export const VideoGames = () => {
  ...
  const { name } = formValues;
    //////////////////////
    const plat = getPlatforms(dataPrueba)
    const gen = getGenres(dataPrueba)

    // 
    ////////////////////////////
  useEffect(() => {
    dispatch(startDataGamesPrueba(dataPrueba))
    dispatch(startDataPlatformPrueba(plat))
    dispatch(startDataGenresPrueba(gen))
